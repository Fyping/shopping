...
<body>
    ...
    <div class="layout_top_header">
            <div style="float: left"><span style="font-size: 16px;line-height: 45px;padding-left: 20px;color: #8d8d8d">优购运营管理后台</h1></span></div>
    ...
    <div id="layout_right_content" class="layout_right_content">
        ...
        <div class="route_bg">
            ...
            <a href="showallproductsforadmin.jsp">菜单管理</a>
        </div>
